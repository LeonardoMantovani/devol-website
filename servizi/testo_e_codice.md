...
<section id="two" class="spotlights">
	...
	<section>
		<img src="{{ "assets/images/logos/hedgedoc.png" | relative_url }}">
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>HedgeDoc</h3>
	...
	<section>
		<img src="{{ "assets/images/logos/privatebin.png" | relative_url }}">
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>PrivateBin</h3>
	...
	<section>
		<img src="{{ "assets/images/logos/gitea.png" | relative_url }}">
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>Gitea</h3>
